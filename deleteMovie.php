...
<html>
    <head>
	    ...
	    <link rel="stylesheet" type="text/css" href="deleteMovieStyle.css">
    ...
    <body>
        ...
        if (isset ($_GET['action']) && isset ($_GET['movieid'])){
            ...
            switch ($action){
                case "delete":
                    ...
                    echo "Error<br/>" . mysqli_query($mysqli, $upit);
                    die();
                    } else {
                ...
                case "change_form":
                    ...
                    if (!$q=$mysqli->query($upit)){
                    echo "<p>Error</p>" . mysqli_query($mysqli, $upit);
                    die();
                    } else {
                        if ($q->num_rows!=1){
                        echo "<p>No movies.</p>";
        ...
        <div class="home">
            <a href="home.php"><button class="button"><h2>homepage</h2></button></a>	
        </div>
    </body>
</html>